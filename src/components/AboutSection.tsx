      ...
      >
        ...
        >
          <Text sx={{ fontSize: '18px', width: matches ? '50%' : '100%' }}>
            ...
            helhetslösningar för varje klient.Vi tror starkt på att varje företag, oavsett storlek eller bransch, har en unik historia
            som förtjänar att berättas. 
          </Text>
          <Text sx={{ fontSize: '18px', width: matches ? '50%' : '100%' }}>
            Vårt uppdrag är att hjälpa dig berätta din historia genom
            innovativa digitala lösningar som verkligen gör skillnad. Det kan handla om att bygga en
            skräddarsydd webbplats, utveckla en e-handelsplattform eller maximera din närvaro på
            sociala medier.
            <br />
            ...
            fulländad digital verklighet. Vi är engagerade i varje steg på vägen mot din
            onlineframgång, från första konsultationen till den färdiga produkten och vidare in i
            framtiden med löpande underhåll och uppdateringar. Vårt mål är att vara mer än en
            leverantör; vi vill vara en långsiktig partner i din digitala resa.
